...
export default function LoginPage() {
    ...
    const isFormValid = watchedFields.identifier?.length > 0 && watchedFields.password?.length > 0
                ...
                <Card className="w-full max-w-md border-yellow-400/30 bg-black/70 backdrop-blur-sm shadow-2xl hover:shadow-yellow-400/20 transition-all duration-500">
                    <CardHeader className="text-center space-y-4">
                        ...
                        <CardTitle className="text-2xl font-bold text-yellow-400 font-fittree tracking-wide hover:tracking-widest transition-all duration-300">
                            {isSubmitting ? "Welcome Back..." : "Sign In to FilmOdyssey"}
                        </CardTitle>
                        <CardDescription className="text-gray-300 text-base hover:text-gray-200 transition-colors duration-300">
                            Track your films, share your reviews, and discover new favorites
                        </CardDescription>
                    </CardHeader>
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <div className="flex items-center justify-between text-sm">
                                    <label className="flex items-center space-x-2 cursor-pointer group">
                                        ...
                                        />
                                        <span className="text-gray-300 group-hover:text-gray-200 transition-colors duration-200">Remember me</span>
                                    </label>
                                    <Link 
                                        href="/forgot-password" 
                                        className="text-yellow-400 hover:text-yellow-300 transition-all duration-300 hover:underline hover:underline-offset-4"
                                    >
                                        Forgot password?
                                    </Link>
                                </div>
